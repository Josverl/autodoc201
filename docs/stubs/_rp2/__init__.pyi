...
For more information and for example code see:
 - `RP2040 Python datasheet <https://datasheets.raspberrypi.com/pico/raspberry-pi-pico-python-sdk.pdf>`_
 - `pico-micropython-examples <https://github.com/raspberrypi/pico-micropython-examples/tree/master/pio>`_
...
class StateMachine:
    ...
    def __init__(
        ...
        *,
        ...
        - *id* the id of the statemachine to configure.
